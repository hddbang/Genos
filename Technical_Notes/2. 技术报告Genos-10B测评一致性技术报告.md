...
​	在此前发布的内容中，我们公布了Genos-10B模型在各数据集上的测评结果。在调研和实践的过程中，我们发现测评结果会受到多种因素的影响，例如随机种子、测评设备、批次大小等。在此技术报告中，我们较为详细的评估了这些因素对测评结果的影响，为该模型的使用者提供一定的参考。

## 一、方法

- ### 测评框架

​	我们的[测评框架](https://github.com/l57/benchmarks)已经开源并且发布在GitHub上，所有测试均使用该框架进行。
...
<center style="font-size:14px;color:#000000;text-decoration:underline">表1 同平台上，改变随机种子对embedding的影响</center> 
...
<div align = "center"><img src="./images-10BBenchmarks/A40-multiseed.png" alt="image-20251201162729003" style="zoom:67%;" />
<center style="font-size:14px;color:#000000;text-decoration:underline">图1.1 A40多随机种子测评结果</center> 



<div align = "center"><img src="./images-10BBenchmarks/A100-multiseed.png" alt="image-20251201162642383" style="zoom:67%;" />
<center style="font-size:14px;color:#000000;text-decoration:underline">图1.2 A100多随机种子测评结果</center> 



<div align = "center"><img src="./images-10BBenchmarks/H100-multiseed.png" alt="image-20251201162642383" style="zoom:67%;" />
<center style="font-size:14px;color:#000000;text-decoration:underline">图1.3 H100多随机种子测评结果</center> 
...
<div align = "center"><img src="./images-10BBenchmarks/multideviceAA.png" alt="multideviceAA" style="zoom:67%;" />


<center style="font-size:14px;color:#000000;text-decoration:underline">图2.1 A40和A100embedding之间的的 a、皮尔森系数，b、余弦相似度，c、均方误差 和d、平均绝对误差</center> 



<div align = "center"><img src="./images-10BBenchmarks/multideviceA40H100.png" alt="multideviceA40H100" style="zoom:67%;" />


<center style="font-size:14px;color:#000000;text-decoration:underline">图2.2 A40和H100embedding之间的的 a、皮尔森系数，b、余弦相似度，c、均方误差 和d、平均绝对误差</center> 

​						

<div align = "center"><img src="./images-10BBenchmarks/multideviceAH100.png" alt="multideviceAH100" style="zoom:67%;" />


<center style="font-size:14px;color:#000000;text-decoration:underline">图2.3 A100和H100embedding之间的的 a、皮尔森系数，b、余弦相似度，c、均方误差 和d、平均绝对误差</center> 
...
<div align = "center"><img src="./images-10BBenchmarks/results-multidevice.png" alt="image-20251202143757475" style="zoom:67%;" />


<center style="font-size:14px;color:#000000;text-decoration:underline">图3 不同设备测评结果的比较</center> 
...
<div align = "center"><img src="./images-10BBenchmarks/embedding-multidevice.png" alt="image-20251202100650287" style="zoom:67%;" />


<center style="font-size:14px;color:#000000;text-decoration:underline">图4 batch size=8和batch size=4之间embedding的 a、皮尔森系数，b、余弦相似度，c、均方误差 和d、平均绝对误差</center> 
...
<div align = "center"><img src="./images-10BBenchmarks/result-multidevice.png" alt="image-20251202095949491" style="zoom:67%;" />


<center style="font-size:14px;color:#000000;text-decoration:underline">图5 batch size=8和batch size=4的测评结果差异</center> 
...
<div align = "center"><img src="./images-10BBenchmarks/A40-42-multilayer.png" alt="image-20251201113735366" style="zoom:67%;" />


<center style="font-size:14px;color:#000000;text-decoration:underline">图6.1 A40 seed=42 multi-layer测评结果</center> 



<div align = "center"><img src="./images-10BBenchmarks/a100-seed42-multilayer.png" alt="image-20251201160327393" style="zoom:67%;" />


<center style="font-size:14px;color:#000000;text-decoration:underline">图6.2 A100 seed=42 multi-layer测评结果</center> 



<div align = "center"><img src="./images-10BBenchmarks/H100-multilayers.png" alt="image-20251201160856462" style="zoom:67%;" />


<center style="font-size:14px;color:#000000;text-decoration:underline">图6.3 H100 seed=42 multi-layer测评结果</center> 
...
> Genos Team, Hangzhou, China. (2025). *Tech-note: Genos-10B Benchmarks research* [Technical Note]. Zenodo. https://doi.org/10.5281/zenodo.17787889

[![DOI]( https://zenodo.org/badge/DOI/10.5281/zenodo.17787889.svg )]( https://doi.org/10.5281/zenodo.17787889 )
