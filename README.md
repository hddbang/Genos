...
- 人类核心语料：核心人类数据集由国际公认的联盟提供的单倍型解析和参考组装组成，包括来自人类泛基因组参考联盟（HPRC，数据发布 2）的 231 个组装，来自人类基因组结构变异联盟（HGSVC）的 65 个组装，来自人类多态性研究中心（CEPH）队列的 21 个基因组，以及 GRCh38 和 CHM13 参考基因组。在严格的质量控制后，该核心数据集包含 636 个高质量的人类基因组，总计约 2,443.5 亿碱基（对应于超过 1,500 亿个标记），并代表了多样化的全球人群。
